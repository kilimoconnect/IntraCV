...
export default function Certifications({ data, style, widthPx, heightPx, isSidebar, sectionTitle, renderSettings: rs }: Props) {
  ...
  return (
    <div style={{
      ...
      <SectionHeading title={sectionTitle || "Certifications"} style={style} isSidebar={isSidebar} renderSettings={rs} />
