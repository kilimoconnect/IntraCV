        ...
        <div className="w-[38%] flex-shrink-0 p-5" style={{ background: BLUE }}>
          ...
          {[
            ...
            <div key={label as string} className="mb-3">
              <div className="text-[7px] font-bold uppercase tracking-widest mb-1.5" style={{ color: TEAL }}>
                {label as string}
              </div>
        ...
        <div className="flex-1 p-5">
          <div className="mb-3">
            ...
            <div className="text-[8px] leading-4 text-slate-600">
              Results-driven Senior Marketing Manager with 9+ years delivering high-impact campaigns. Generated £4.1M in attributable revenue in FY2023.
            </div>
          </div>
          <div className="mb-3">
            ...
            {[
              ...
              <div key={e.role} className="mb-2.5 pl-2 border-l-2" style={{ borderColor: BLUE }}>
                ...
                {e.bullets.map((b) => (
                  <div key={b} className="text-[7px] text-slate-600 leading-3.5 mb-0.5">• {b}</div>
                ))}
              </div>
            ))}
          </div>
        ...
        <motion.div variants={stagger(0.1)} initial="hidden" animate="show">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3 mb-10">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl font-bold text-white text-base"
...
function PainSection() {
  const pains = [
    "Spending hours rewriting your CV for every job",
    "Not hearing back despite sending dozens of applications",
    "ATS software rejecting your CV before any human sees it",
    "Generic CVs that don't match the job description",
    "Not knowing if your layout or content is the problem",
    "Watching less-qualified candidates get the interviews",
  ];
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Sound familiar?</h2>
          ...
          <motion.div variants={stagger(0.06)} initial="hidden" whileInView="show" viewport={{ once: true }}
            ...
            {pains.map((text) => (
              <motion.div key={text} variants={fadeUp} className="flex items-start gap-3 bg-white rounded-xl p-4 border border-red-100 shadow-sm">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.1)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">See the difference AI makes</h2>
            <p className="text-lg text-slate-500 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div variants={slideRight} className="rounded-2xl border-2 border-red-200 bg-red-50 p-6">
              ...
              <div className="mt-5 pt-4 border-t border-red-200 text-xs text-red-500 font-medium">Rejected by ATS — no human ever reads it</div>
            </motion.div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.1)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">From upload to interview in 4 steps</h2>
            <p className="text-lg text-slate-500 max-w-xl mx-auto">No CV writing experience needed. No hours spent reformatting. Just results.</p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {steps.map(({ n, icon, title, body }, i) => (
              <motion.div key={n} variants={fadeUp} custom={i}
                ...
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4 text-white" style={{ background: BLUE }}>{icon}</div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">One tool. Your entire job search.</h2>
            <p className="text-lg text-slate-500 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map(({ icon, color, title, body }) => (
              <motion.div key={title} variants={fadeUp} whileHover={{ y: -3, boxShadow: "0 12px 32px rgba(0,0,0,0.09)" }}
                ...
                <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-white" style={{ background: color }}>{icon}</div>
                <h3 className="font-bold text-slate-900 mb-2 text-sm">{title}</h3>
                <p className="text-xs text-slate-500 leading-relaxed">{body}</p>
              </motion.div>
            ))}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Job seekers who got interviews</h2>
            <p className="text-lg text-slate-500 max-w-xl mx-auto">Used by professionals across 30+ countries — from graduates to executives.</p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-4">Common questions</h2>
          </motion.div>
          <div className="space-y-3">
            {faqs.map(({ q, a }, i) => (
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <motion.div variants={stagger(0.1)} initial="hidden" whileInView="show" viewport={{ once: true }}>
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button onClick={handleCTA} whileHover={{ scale: 1.04, boxShadow: `0 0 40px ${ORANGE}55` }} whileTap={{ scale: 0.97 }}
