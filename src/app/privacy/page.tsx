      ...
      <main className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <Section title="2. Data We Collect">
          ...
          <ul className="space-y-3">
            ...
            <Li title="Payment data">If you purchase a CV download, payment is processed by Flutterwave. We receive only a transaction status — no card or bank details are stored on our servers.</Li>
          </ul>
        </Section>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {[
                  ...
                  ["Flutterwave", "Payment processing for CV downloads"],
